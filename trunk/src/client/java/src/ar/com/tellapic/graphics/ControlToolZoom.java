...
public final class ControlToolZoom extends ControlTool implements ComboBoxModel{
	...
	private static class Holder {
		private static ControlToolZoom INSTANCE = new ControlToolZoom();
	}
	
	private ControlToolZoom() {
		super(99, ControlToolZoom.class.getSimpleName(), ZOOM_ICON_PATH, Utils.msg.getString("zoomtooltip"), Cursor.getPredefinedCursor(Cursor.CROSSHAIR_CURSOR));
...
//		Image image = toolkit.getImage(ZOOMOUT_ICON_PATH);
	 ...
	 * @return
	 */
	public static ControlToolZoom getInstance() {
