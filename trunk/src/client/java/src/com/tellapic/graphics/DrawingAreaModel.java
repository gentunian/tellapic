...
public class DrawingAreaModel extends Observable implements IDrawingAreaState, IDrawingAreaManager {
	...
	/* (non-Javadoc)
	 * @see com.tellapic.graphics.IDrawingAreaState#getDrawing(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.tellapic.graphics.IDrawingAreaState#getDrawings()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.tellapic.graphics.IDrawingAreaManager#removeDrawing(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.tellapic.graphics.IDrawingAreaManager#removeLastDrawing()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.tellapic.graphics.IDrawingAreaManager#addDrawing(com.tellapic.graphics.Drawing)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.tellapic.graphics.IDrawingAreaManager#removeDrawing(com.tellapic.graphics.Drawing)
	 */
	@Override
