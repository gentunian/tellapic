...
class FontWidgetPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):

    def __init__(self, parent = None):
        super(FontWidgetPlugin, self).__init__(parent)
    ...
    def domXml(self):
        return '<widget class="FontWidget" name="fontWidget">\n' \
