...
public class PaintPropertyController implements IPaintPropertyController {
	...
	/* (non-Javadoc)
	 * @see com.tellapic.graphics.IPaintPropertyController#handleOpacityChange(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.tellapic.graphics.IPaintPropertyController#handleWidthChange(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.tellapic.graphics.IPaintPropertyController#handleEndCapsChange(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.tellapic.graphics.IPaintPropertyController#handleLineJoinsChange(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.tellapic.graphics.IPaintPropertyController#handleFontFaceChange(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.tellapic.graphics.IPaintPropertyController#handleFontSizeChange(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.tellapic.graphics.IPaintPropertyController#handleFontStyleChange(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.tellapic.graphics.IPaintPropertyController#handleTextChange(java.lang.String)
	 */
	@Override
